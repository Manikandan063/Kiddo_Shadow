        ...
        <div className="flex-1 overflow-y-auto p-8 md:p-16 space-y-12 custom-scrollbar">
          ...
          <div className="grid grid-cols-1 gap-12">
            ...
            <div className="pt-12 border-t border-foreground/5 text-center">
              <p className="text-foreground/30 text-xs font-bold uppercase tracking-[0.3em] mb-4">Contact Billing Department</p>
              ...
              <p className="text-foreground/20 text-[10px] font-bold uppercase tracking-widest mt-6">Finance Department – Xtown Technologies Pvt. Ltd.</p>
            </div>
          </div>
        </div>
      </DialogContent>
