        ...
        <div className="flex-1 overflow-y-auto p-8 md:p-16 space-y-12 custom-scrollbar">
          ...
          <div className="grid grid-cols-1 gap-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-6 rounded-3xl bg-foreground/[0.02] border border-foreground/5 text-center">
                    ...
                    <p className="text-foreground/50 dark:text-foreground/30 text-xs leading-relaxed">{item.desc}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <div className="pt-12 border-t border-foreground/5 text-center">
              <p className="text-foreground/50 dark:text-foreground/30 text-xs font-bold uppercase tracking-[0.3em] mb-4">Contact Moderation Department</p>
